...
Class VirtualMachineSgx {
    ...
    VirtualMachineSgx([Microsoft.Management.Infrastructure.CimInstance] $VmSgx) {
...
Function Get-VMSgxMemorySettingData([Microsoft.HyperV.PowerShell.VirtualMachine] $Vm) {
    $Mem = Get-CimInstance -Namespace root/virtualization/v2 -Class Msvm_MemorySettingData |
...
Function Get-VMSgxManagementService() {
    $Svc = Get-CimInstance -Namespace root/virtualization/v2 -Class Msvm_VirtualSystemManagementService |
    Where-Object {
...
Function Set-VMSgx {
    ...
    Process {
        ...
        $MemSerialized = $serializer.Serialize($Mem, [Microsoft.Management.Infrastructure.Serialization.InstanceSerializationOptions]::None)
        $MemString = [System.Text.Encoding]::Unicode.GetString($MemSerialized)
        $Ret = Invoke-CimMethod -InputObject $Svc -MethodName ModifyResourceSettings -Arguments @{ ResourceSettings=@($MemString) }
